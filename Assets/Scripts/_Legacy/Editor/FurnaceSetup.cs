...
// the pre-Core-60 Assets/Prefabs/Furnace.prefab (archived to
// _Archived/Legacy/Prefabs/Furnace.prefab in V5.1) into the scene. The
// replacement furnace is procedurally generated by Volume 3.3
// (Assets/ScriptableObjects/Generated/Items/furnace.asset + matching
// world prefab). Preserved for historical reference.
using UnityEditor;
using UnityEngine;
