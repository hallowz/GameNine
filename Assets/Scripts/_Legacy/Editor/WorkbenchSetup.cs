// LEGACY — Volume 5.3. Editor-only setup utility that built and placed
// the pre-Core-60 Assets/Prefabs/Workbench.prefab (archived to
// _Archived/Legacy/Prefabs/Workbench.prefab in V5.1) into the scene and
// wired ThreeByThreeRecipeCreator recipes. The replacement workbench is
// procedurally generated by Volume 3.3
// (Assets/ScriptableObjects/Generated/Items/workbench.asset + matching
// world prefab) and recipes are Core-60-scoped from items_core.json.
