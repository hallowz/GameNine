// LEGACY — Volume 5.3. Editor-only utility that built the 5 starter
// CraftingRecipe assets at Assets/ScriptableObjects/Recipes/. Those
// assets were archived to _Archived/Legacy/Recipes/ in V5.1. The
// replacement is RecipeDefinition + RecipeSoGenerator (V2.x). The
// runtime CraftingRecipe class is still consumed by the live crafting
// pipeline so it lives at Assets/Scripts/_Legacy/Crafting/CraftingRecipe.cs
// (preserved by V2.2). Only this asset-creation helper is here.
using System.IO;
using UnityEditor;
using UnityEngine;
